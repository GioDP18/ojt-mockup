		...
		<div class="form-container">
			...
			<form class="form" @submit.prevent="handleRegister">
				<div class="input-group">
					...
					<input v-model="fullname" type="text" name="fullname" id="fullname" placeholder="" />
				</div>
				<div class="input-group">
				...
				<div class="input-group mb-3">
					...
					<input v-model="confirm_password" type="password" name="confirm_password" id="confirm_password" placeholder="" />
				</div>
			...
			<div class="social-icons">
				<button aria-label="Log in with Google" class="icon" @click="loginWithGoogle">
					<!-- Google SVG -->
				...
				<button aria-label="Log in with Twitter" class="icon" @click="loginWithTwitter">
					<!-- Twitter SVG -->
					<div class="child child-1">
						<button class="button btn-1">
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" class="w-5 h-5 fill-current">
				...
				<button aria-label="Log in with GitHub" class="icon" @click="loginWithGitHub">
					<!-- GitHub SVG -->
					<div class="child child-1">
						<button class="button btn-1">
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" class="w-5 h-5 fill-current">
